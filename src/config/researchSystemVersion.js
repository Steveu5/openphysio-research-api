const RESEARCH_SYSTEM_VERSION = Object.freeze({
  ...
  confidence_model_version: "1.1.0",
  evidence_selection_version: "1.2.0",
  research_result_quality_version: "1.0.0",
  research_search_summary_version: "1.0.0",
  research_answer_safety_version: "1.0.0",
